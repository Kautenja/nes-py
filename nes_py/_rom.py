...
class ROM(object):
    ...
    def header(self) -> bytes:
        """Return the header of the ROM file."""
    ...
    @property
    def is_ignore_mirroring(self) -> bool:
    ...
    @property
    def has_battery_backed_ram(self) -> bool:
    ...
    @property
    def has_play_choice_10(self) -> bool:
        """
    ...
    @property
    def has_vs_unisystem(self) -> bool:
        """
    ...
    @property
    def trainer_rom_start(self) -> bytes:
        """The inclusive starting index of the trainer ROM."""
        return 16

    @property
    def trainer_rom_stop(self) -> bytes:
