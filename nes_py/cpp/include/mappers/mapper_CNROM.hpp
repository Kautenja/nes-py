...
public:
    ...
    ///
    void writePRG (NES_Address address, NES_Byte value) { m_selectCHR = value & 0x3; };
    ...
    ///
    NES_Byte readCHR (NES_Address address) { return m_cartridge.getVROM()[address | (m_selectCHR << 13)]; };
